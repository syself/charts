...
If you're new to the project and want to help, but don't know where to start, we have a semi-curated list of issues that should not need deep knowledge of the system. [Have a look and see if anything sounds interesting](https://github.com/syself/charts/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22). 
Before starting to work on the issue, make sure that it doesn't have a [lifecycle/active](https://github.com/syself/charts/labels/lifecycle%2Factive) label. If the issue has been assigned, reach out to the assignee.
...
Charts has three types of branches: the *main* branch,
*release-X* branches and the gh-pages branch.
